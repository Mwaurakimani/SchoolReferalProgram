...
@section('content')
    ...
    <div class="container pt-[20px] mb-[50px] max-w-[1000px]">
        ...
        <h3>Who we are</h3>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium dolore doloribus hic inventore ipsum minus odit, optio ratione! Consequuntur dicta ea expedita facilis in minus nisi non odit, omnis sapiente.</p>
